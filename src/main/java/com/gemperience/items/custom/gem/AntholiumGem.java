...
public class AntholiumGem extends AbstractGemItem {
    public AntholiumGem(Settings settings) {
        super(settings);
    }
    ...
    public void crushGem(ServerWorld world, BlockPos pos) {
        ...
        world.playSound(null, pos, SoundEvents.BLOCK_AMETHYST_BLOCK_CHIME, SoundCategory.BLOCKS, .75f, 1);
        world.spawnParticles(
                new BlockStateParticleEffect(ParticleTypes.BLOCK, ModBlocks.ANTHOLIUM_BLOCK.getDefaultState()),
