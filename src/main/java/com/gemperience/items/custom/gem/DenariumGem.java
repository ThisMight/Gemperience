...
public class DenariumGem extends AbstractGemItem {
    public DenariumGem(Settings settings) {
        super(settings);
    }
    ...
    public void crushGem(ServerWorld world, BlockPos pos) {
        ...
        world.spawnParticles(
                new BlockStateParticleEffect(ParticleTypes.BLOCK, ModBlocks.DENARIUM_BLOCK.getDefaultState()),
