...
public class GlazoniumGem extends AbstractGemItem {
    public GlazoniumGem(Settings settings) {
        super(settings);
    }
    ...
    public void crushGem(ServerWorld world, BlockPos pos) {
        ...
        world.playSound(null, pos, SoundEvents.ENTITY_ENDERMAN_TELEPORT, SoundCategory.BLOCKS, .75f, 1);
        world.spawnParticles(
                new BlockStateParticleEffect(ParticleTypes.BLOCK, ModBlocks.GLAZONIUM_BLOCK.getDefaultState()),
