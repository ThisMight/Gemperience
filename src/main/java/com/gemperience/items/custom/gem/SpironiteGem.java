...
public class SpironiteGem extends AbstractGemItem {
    public SpironiteGem(Settings settings) {
        super(settings);
    }
    ...
    public void crushGem(ServerWorld world, BlockPos pos) {
        ...
        world.playSound(null, pos, SoundEvents.BLOCK_BONE_BLOCK_HIT, SoundCategory.BLOCKS, .75f, 1);
        world.spawnParticles(
                new BlockStateParticleEffect(ParticleTypes.BLOCK, ModBlocks.SPIRONITE_BLOCK.getDefaultState()),
