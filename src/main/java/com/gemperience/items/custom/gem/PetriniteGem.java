...
public class PetriniteGem extends AbstractGemItem {
    public PetriniteGem(Settings settings) {
        super(settings);
    }
    ...
    public void crushGem(ServerWorld world, BlockPos pos) {
        ...
        world.playSound(null, pos, SoundEvents.BLOCK_GRASS_BREAK, SoundCategory.BLOCKS, .75f, 1);
        world.spawnParticles(
                new BlockStateParticleEffect(ParticleTypes.BLOCK, ModBlocks.PETRINITE_MUD.getDefaultState()),
